...
import { ArrowLeft, Bell, CheckCircle2, Gift, Megaphone, Sparkles, Stamp, Tags, Users } from "lucide-react";
...
const ACTIONS = [
  ...
  { to: "/admin/subscription", label: "Se abonnement", icon: Sparkles },
];
    ...
    <div className="min-h-screen bg-paper text-[#2C2A26]">
      ...
      <main className="mx-auto max-w-screen-lg space-y-6 px-4 py-6">
        ...
        <section className="rounded-3xl border border-[#EBE5DC] bg-white p-5">
          ...
          <p className="mt-2 text-sm text-[#6B655B]">Etiketter brukes til å finne og målrette kundegrupper i kampanjer og varsler.</p>
